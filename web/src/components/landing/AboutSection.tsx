          ...
          >
            ...
            >
              ...
              <div className="p-6 font-mono text-sm space-y-2">
                <div style={{ color: '#5E6673' }}>$ git clone https://github.com/AuaiexAI/auaiex.git</div>
                <div style={{ color: '#5E6673' }}>$ cd auaiex && chmod +x start.sh</div>
