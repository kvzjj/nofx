...
See [Issue #202](https://github.com/kvzjj/auaiex/issues/202) and [Troubleshooting Guide](TROUBLESHOOTING.md#-only-opening-short-positions-issue-202).
...
2. Search [existing issues](https://github.com/kvzjj/auaiex/issues)
...
Open a [Feature Request](https://github.com/kvzjj/auaiex/issues/new/choose) with your idea!
