...
- **Binance Futures + паперова торгівля**: жива торгівля на Binance Futures плюс вбудований симулятор біржі (реальні ринкові ціни, локальне виконання) для перевірки стратегій без ризику
