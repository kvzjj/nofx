...
- **Binance Futures + бумажная торговля**: живая торговля на Binance Futures плюс встроенный симулятор биржи (реальные рыночные цены, локальное исполнение) для проверки стратегий без риска
...
- **GitHub Issues**: [Создать Issue](https://github.com/kvzjj/auaiex/issues)
